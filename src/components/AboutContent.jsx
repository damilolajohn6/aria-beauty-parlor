...
const AboutContent = () => {
  return (
    <section className="bg-white py-12 px-6">
      <div className="flex flex-col-reverse lg:flex-row mx-auto items-center my-6 px-12 gap-8 justify-center">

        <div className="lg:w-1/2">
          <h3 className="text-3xl md:text-4xl font-serif font-bold text-[#6C5E46]">
      ...
      <div className="flex flex-col lg:flex-row mx-auto my-6 items-center px-12 gap-8 justify-center">
